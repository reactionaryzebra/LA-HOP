      ...
      <div>
        ...
        <FormOne style={{ display: this.state.pageTwoVis }}>
          <div className="gradientDiv">
            ...
            <h5>
              Tell us more about the person in need and provide optional contact
        ...
        <FormOne style={{ display: this.state.pageThreeVis }}>
          <div className="gradientDiv">
            <h2>
              {this.state.english
                ? "Person in Need Description"
                : "Descripción de personas sin hogar"}
            </h2>
            <h5>
              Provide as detailed a description of the person(s) in need
              physical appearance, and your best assessment of their needs.
            </h5>
            <br />
            <img
              className="cameraImg"
            ...
            <h2>Add a Photo</h2>
            <h5>
              Take or upload a photo (optional). If the person(s) is exhibiting
              behavior that is endangering themselves or the public, or need
              immediate medical, call 911 immediately.
            </h5>
